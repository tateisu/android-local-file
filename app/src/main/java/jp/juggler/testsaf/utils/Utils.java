...
public class Utils{
	...
	public static void showToast( Context context, boolean bLong, String fmt,Object... args ){
	...
	public static void showToast(  Context context,Throwable ex,  String fmt,Object... args ){
		Toast.makeText(
			context
	...
	public static void showToast( Context context, boolean bLong, int string_id,Object... args ){
		Toast.makeText(
			context
	...
	public static void showToast(  Context context,Throwable ex,   int string_id,Object... args ){
		Toast.makeText(
			context
